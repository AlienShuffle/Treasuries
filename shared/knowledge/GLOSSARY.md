# TIPS Portal Master Glossary

This document is the authoritative source for all financial concepts, mathematical formulas, and terminology used across the TIPS Portal projects.

---

## 1.0 Core Financial Primitives
Basic building blocks for all treasury and debt instruments.

### Quantity
**Definition:** The number of $1,000 units of a security.
**Unit:** Integer (e.g., 50).
...
**Definition:** Actual nominal cash flow produced by the ladder for a funded year.

### DARA
**Full name:** Desired Annual Real Amount
**Definition:** The target annual income in inflation-adjusted dollars.

### ARA
**Full name:** Annual Real Amount
**Definition:** The actual annual income generated by a specific year of the ladder.
